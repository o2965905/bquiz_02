...
CREATE TABLE `news` (
  ...
  `type` tinyint(1) NOT NULL COMMENT '分類',
  `good` int(11) NOT NULL COMMENT '按讚數',
...
CREATE TABLE `que` (
  ...
  `subject_id` int(11) UNSIGNED NOT NULL COMMENT '題目id',
  `count` int(11) UNSIGNED NOT NULL COMMENT '統計'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `que` (`id`, `text`, `subject_id`, `count`) VALUES
...
(8, '2.對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病', 6, 0),
...
(8, '222', '222', '222@gmail.com'),
(10, '444', '444', '444@gmail.com');
